...
void EFT_AAttbarProcess::sigmaKin() 
{
...
double EFT_AAttbarProcess::sigmaHat() 
{
...
void EFT_AAttbarProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
...
double EFT_AAttbarProcess::matrix_1_aa_ttx() 
{
  int i, j; 
  // Local variables
  const int ngraphs = 1; 
